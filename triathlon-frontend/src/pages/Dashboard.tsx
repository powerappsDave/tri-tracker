...
const Dashboard:React.FC<IDashboardProps> = ({userId}) => {

  const [loggedInUser, setLoggedInUser] = useState<IProps["loggedInUser"]>(
    {
      id: 0,
      name: '',
      email: '',
  ...
  const [displayUser, setDisplayUser] = useState<IProps["loggedInUser"]>({
      id: 0,
      name: '',
      email: '',
      role: ''
